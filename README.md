...
We provide NeRF output [examples](https://drive.google.com/drive/folders/18lEtLgHsVVXNjgkxReONYhoSKXsbUYiP?usp=drive_link) to run this pipeline. Additionally, the dataset contains raw data and SfM-processed data to run your own NeRF/3DGS model. [The project page is here](https://dynamic.robots.ox.ac.uk/projects/sapling-nerf/).
