for i in {1..8}; do
  ...
  train_cmd="ns-train nerfacto \
      ...
      --vis wandb \
      --experiment-name sapling-0${i} \
      --pipeline.model.camera-optimizer.mode off \
      nerfstudio-data --data /home/docker_dev/data/saplings_nerf/2025-08-14-wytham/sapling-0${i}/raw/ \
  ...
  # export point cloud
  latest_run=$(ls -td /home/docker_dev/saplings_nerf/outputs/sapling-0${i}/nerfacto/* | head -1)
  echo -e "\033[1;36mLatest run directory:\033[0m $latest_run"
  export_cmd="ns-export pointcloud \
      --load-config ${latest_run}/config.yml \
      --output-dir /home/docker_dev/saplings_nerf/eval_pointcloud \
      --num-points 5000000 \
